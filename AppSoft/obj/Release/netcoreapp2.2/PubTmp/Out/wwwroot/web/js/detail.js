...
layui.use(['flow', 'layedit', 'laytpl'], function () {
    ...
    $(document).ready(function () {
        showmsg();
        //文章分类
        $.get("/category/index", "", function (result) {
        ...
        //热门文章
        $.get("/article/hot", "", function (result) {
            var getTpl = hotview.innerHTML;
            laytpl(getTpl).render(result, function (html) {
                $("#hot").append(html);
            });
        })
        $.get("/article/random", "", function (result) {
            var tpl = randomview.innerHTML;
            laytpl(tpl).render(result, function (html) {
                $("#random").after(html);
            });
        });
...
function nextpage(elem) {
    ...
    $.get("/home/replypage", { "pageindex": page, "rootid": rootid, "aid": aid }, function (result) {
